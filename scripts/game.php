...
if(isset($_GET['answer'])) {
    ...
    $corrent_question = $_SESSION['game']['corrent_question'];

    // get answer
    $answer = $_GET['answer'];
    $answer_given = $_SESSION['questions'][$corrent_question]['answers'][$answer];

    // check if answer is correct
    if($answer_given == $_SESSION['questions'][$_SESSION['game']['corrent_question']]['correct_answer']) {
    ...
    if($_SESSION['game']['corrent_question'] == $_SESSION['game']['total_questions'] - 1) {
        header('Location: index.php?route=gameover');
        exit;
    }

    // increment current question
    $_SESSION['game']['corrent_question']++;
...
$country = $_SESSION['questions'][$corrent_question]['question'];
$answers = $_SESSION['questions'][$corrent_question]['answers'];
    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <div class="card p-5">
                ...
                <div class="row">
                    <div class="col">
                        <h5 class="text-success">Questão n.º <strong><?= $corrent_question + 1 . ' / ' . $total_questions ?></strong></h5>
                    </div>
